...
public protocol EndpointConfigurable {
    ...
    var method: HTTPMethodType { get }
    var headers: [String: String] { get }
    var queryEncodableObject: Encodable? { get }
    var queryParams: [String: Any] { get }
    var bodyEncodableObject: Encodable? { get }
    var bodyParams: [String: Any] { get }
    var bodyEncoding: BodyEncoding { get }
    var responseDecoder: ResponseDecoder { get }
    
    func endpoint<T>() -> Endpoint<T>
}

public extension EndpointConfigurable {
    func endpoint<T>() -> Endpoint<T> {
        .init(path: self.path,
              isFullPath: self.isFullPath,
              method: self.method,
              headerParamaters: self.headers,
              queryParametersEncodable: self.queryEncodableObject,
              queryParameters: self.queryParams,
              bodyParamatersEncodable: self.bodyEncodableObject,
              bodyParamaters: self.bodyParams,

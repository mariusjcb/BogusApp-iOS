...
public final class ChannelsListRowItem: NSObject {
    ...
    func configure(with viewModel: ChannelsListItemViewModel) {
        ...
        selectedPlanLabel.setText(String(format: NSLocalizedString("Monthly fee: %g€", comment: ""), viewModel.selectedPlan?.price ?? 0))
    }
}

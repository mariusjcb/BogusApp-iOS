...
final class TargetsSceneDIContainer {
    ...
    func makeTargetsListController(actions: TargetsListViewModelActions)
        ...
        return .init(name: TargetsListInterfaceController.reuseIdentifier,
                     context: .init(viewModel: makeTargetsListViewModel(actions: actions)))
    }

    func makeTargetsListViewModel(actions: TargetsListViewModelActions)
    ...
    func makeChannelsListViewModel(for targets: [TargetSpecific], actions: ChannelsListViewModelActions)
    ...
    func makePlansListViewModel(for channel: Channel,
                                plans: [Plan],
                                didSet: @escaping (Int) -> Void) -> PlansListViewModel {
    ...
    func makeCampaignReviewController(for targets: [TargetSpecific],
        ...
        return .init(name: CampaignReviewInterfaceController.reuseIdentifier,
                     context: .init(viewModel: makeCampaignReviewViewModel(for: targets,
